...
import { CantiereReportDashboard } from './CantiereReportDashboard.jsx'; // Assicurati che il percorso sia corretto
import { FormList, FormReader } from 'shared-ui';
import { AssegnaCantiereForm } from './AssegnaCantiereForm.jsx';
// --- ✅ TEST PER VEDERE SE IL FILE VIENE LETTO ---
const TEST_ERRORE = NON_ESISTE;
// --- FINE TEST ---
...
export const MainOperativeView = ({ onBack }) => {
    ...
    // --- ✅ 1. CORREZIONE DEFINITIVA: Estrai 'userRole' e 'companyFeatures' ---
    const { 
        db, 
        user, 
        userAziendaId, 
        userRole,        // <-- ESTRATTO CORRETTAMENTE
        companyFeatures, // <-- ESTRATTO CORRETTAMENTE
        data, 
        loadingData 
    } = useFirebaseData();
    
    // --- ✅ 2. LOG DI DEBUG nel Genitore ---
    console.log("--- DEBUG GESTIONE OPERATIVA (Genitore) ---");
    console.log("Valore 'userRole' letto dal contesto:", userRole);
    console.log("Valore 'companyFeatures' letto dal contesto:", companyFeatures);
    // --- FINE DEBUG ---
    ...
    const renderContent = () => {
        ...
        // --- ✅ TEST PER FORZARE LA CACHE ---
        return <h1 className="text-4xl text-red-500 p-10">TEST AGGIORNAMENTO FILE</h1>;
        // --- FINE TEST ---
        ...
        switch (currentView) {
            ...
            // --- ✅ 3. CORREZIONE DEFINITIVA: Passa le props separate ---
